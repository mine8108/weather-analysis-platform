...
# ============================================================
# 七、大气环境质量标准 (GB 3095-2012 + HJ 633-2012 AQI)
# ============================================================

# 各污染物浓度→AQI分指数计算断点 (μg/m³, CO为mg/m³)
# 格式: (浓度下限, 浓度上限, AQI下限, AQI上限)
_AQI_BREAKPOINTS = {
    "so2":  [(0, 50, 0, 50), (51, 150, 51, 100), (151, 475, 101, 150),
             (476, 800, 151, 200), (801, 1600, 201, 300), (1601, 2620, 301, 500)],
    "nox":  [(0, 40, 0, 50), (41, 80, 51, 100), (81, 180, 101, 150),
             (181, 280, 151, 200), (281, 565, 201, 300), (566, 940, 301, 500)],
...
# 大气污染物标准浓度限值 (GB 3095-2012 二级标准, μg/m³)
# 用于简单的达标判断
AIR_POLLUTANT_LIMITS = {
    "so2":  {"annual": 60, "daily": 150, "hourly": 500},
    "nox":  {"annual": 40, "daily": 80,  "hourly": 200},
    "pm10": {"annual": 70, "daily": 150},
    "pm25": {"annual": 35, "daily": 75},
