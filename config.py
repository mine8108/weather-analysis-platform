...
# ============================================================
# 七、大气环境质量标准 (GB 3095-2026 + HJ 633-2026 AQI)
# 2026年2月13日发布，2026年3月1日实施，替代 GB 3095-2012
# 分两阶段：Phase1(2026.3-2030.12过渡) / Phase2(2031.1起终版)
# ============================================================
...
AQI_BREAKPOINTS = {
    ...
    "nox":  [(0, 40, 0, 50), (41, 60, 51, 100), (81, 120, 101, 150),
             (121, 200, 151, 200), (201, 400, 201, 300), (401, 800, 301, 500)],
    "pm10": [(0, 50, 0, 50), (51, 120, 51, 100), (121, 250, 101, 150),
             (251, 350, 151, 200), (351, 420, 201, 300), (421, 600, 301, 500)],
    # HJ 633-2026: PM2.5日均断点按新标准收严 (二级日均50μg/m³)
    "pm25": [(0, 25, 0, 50), (26, 50, 51, 100), (51, 100, 101, 150),
             (101, 150, 151, 200), (151, 200, 201, 300), (201, 400, 301, 500)],
}
