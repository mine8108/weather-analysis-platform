...
- Produces:
  - `modules.era5_guide.KEYS_ALLOWED_BY_TYPE: dict[str, tuple[str, ...]]`
...
KEYS_ALLOWED_BY_TYPE = {
    "hourly": ("area", "data_format", "day", "download_format", "month",
               "time", "variable", "year"),
    "pressure": ("area", "data_format", "day", "download_format", "month",
                 "pressure_level", "product_type", "time", "variable", "year"),
    "monthly": ("area", "data_format", "download_format", "month",
